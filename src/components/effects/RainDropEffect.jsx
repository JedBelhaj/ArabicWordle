...
const ALPHABET =
  "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzأبتثجحخدذرزسشصضطظعغفقكلمنهويءآأؤإئىةΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩабвгдеёжзийклмнопрстуфхцчшщъыьэюяあいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめもやゆよらりるれろわをん的一是在有和人中大上‼ඞ☻☺✿❀✬♥☼☾ツ♔♕♖♗♘♙♚♛♜♝♞♟✈☁☂☃☘☙☚☛☜☞☟✎⚀⚁⚂⚃⚄⚅";
const EFFECT_CONFIG = {
  RAINDROP: {
    MAX_COUNT: 30,
    MIN_DURATION: 15000,
...
const RainDropLetter = ({ letter, duration, delay, index, mouseX, mouseY }) => {
  ...
  const textShadow = useMemo(
    () => `0 0 8px ${color}, 0 0 16px ${color}99`,
    [color],
  );
  ...
  return (
    <div
      ...
      style={{
        ...
        fontSize,
        textShadow: isNear
          ? `0 0 16px ${HIGHLIGHT_COLOR}, 0 0 32px ${HIGHLIGHT_COLOR}99`
          : textShadow,
        fontWeight: 700,
